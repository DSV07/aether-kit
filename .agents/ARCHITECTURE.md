...
## 🧠 Adaptive Learning Layer (2026.7.1)

Sistema de aprendizado adaptativo que permite ao AG-KIT 2.0 aprender preferências, correções e padrões do usuário.

### New Agents (4)

| Agent | Focus | Skills |
|-------|-------|--------|
| `coordinator` | Task coordination with memory awareness | adaptive-user-learning, coordinator-mode, intelligent-routing |
| `learning-manager` | Adaptive learning lifecycle management | adaptive-user-learning, skill-generator, memory-system |
| `design-agent` | UI/UX with user visual preferences | adaptive-user-learning, frontend-no-ai-look, frontend-design |
| `prompt-engineer` | Communication optimization | adaptive-user-learning, brainstorming |

### New Skills (5)

| Skill | Description |
|-------|-------------|
| `adaptive-user-learning` | Core learning process: consult, apply, save |
| `araujo-dev-default-stack` | User's default stack: React+Vite+TS, Node+Express, MySQL |
| `frontend-no-ai-look` | Anti-AI-look visual design rules |
| `backend-real-data` | Real data backend patterns (no mocks) |
| `skill-generator` | Meta-skill for generating Skills from memories |

### New Workflows (6)

| Workflow | Trigger |
|----------|---------|
| `pre-task-memory-check` | Before any task |
| `learn-from-correction` | When user corrects agent |
| `promote-memory-to-skill` | When 5+ rules consolidate |
| `resolve-memory-conflict` | When new instruction conflicts |
| `memory-maintenance` | Periodic cleanup |
| `post-task-learning-review` | After large tasks |

### MCP Server

| Server | Transport | Tools |
|--------|-----------|-------|
| `antigravity-learning-mcp` | stdio | 11 tools (save, search, list, update, delete, detect_conflicts, promote_to_skill, classify_instruction, summarize, export, import) |

### Memory Files

| File | Purpose |
|------|---------|
| `preferences.yml` | User preferences (communication, style) |
| `corrections.yml` | Explicit corrections |
| `stacks.yml` | Tech stack patterns |
| `design-patterns.yml` | Visual design patterns |
| `project-rules.yml` | Project-specific rules |
| `workflows.yml` | Workflow preferences |
| `ignored-patterns.yml` | Patterns NOT to learn |
| `rules-index.yml` | Quick search index |
...
| Metric              | Value                             |
| ------------------- | --------------------------------- |
| **Total Agents**    | 24 (+4 in 2026.7.1)              |
| **Total Skills**    | 52 (+5 in 2026.7.1)              |
| **Total Workflows** | 19 (+6 in 2026.7.1)              |
| **Total Scripts**   | 2 (master) + 16 (skill-level)     |
| **MCP Servers**     | 1 (antigravity-learning-mcp)      |
| **Coverage**        | ~95% web/mobile + orchestration + adaptive learning |
...
| Learning | `learning-manager`    | adaptive-user-learning, skill-generator |
| Coordinate | `coordinator`       | adaptive-user-learning, coordinator-mode |
| Design   | `design-agent`        | frontend-no-ai-look, frontend-design |
